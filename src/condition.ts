...
export function parseCondition(condition: string, val: string | boolean | number | null | any[]): validTypes  {
  ...
  const children: validTypes[] = rawChildren.map(child => parseCondition(child, val))
...
export function evaluateCondition(parsedTree: validTypes) {
  if (typeof parsedTree === "string" || typeof parsedTree === "number" || typeof parsedTree === "boolean" || parsedTree === null) return parsedTree

  const children: any[] = parsedTree.children.map(child => evaluateCondition(child))
  ...
  switch (parsedTree.condition) {
    ...
    case "starts_with":
      ...
      if(typeof children[0] !== "string" || typeof children[1] !== "string") throw "Expected both children of startsWith to be a string"
      return children[0].startsWith(children[1])
    
    case "ends_with":
      if(children.length !== 2) throw "Expected 2 children for endsWith"
      if(typeof children[0] !== "string" || typeof children[1] !== "string") throw "Expected both children of endsWith to be a string"
      return children[0].endsWith(children[1])
    
    case "to_lower":
      if(children.length !== 1) throw "Expected 1 child for to_lower"
      if(typeof children[0] !== "string" ) throw "Expected child of to_lower to be a string"
      return children[0].toLowerCase()
    
    case "to_upper":
      if(children.length !== 1) throw "Expected 1 child for to_upper"
      if(typeof children[0] !== "string" ) throw "Expected child of to_upper to be a string"
      return children[0].toUpperCase()
    
    case "gt":
      if(children.length !== 2) throw "Expected 2 children for gt"
      if(typeof children[0] !== "number" || typeof children[1] !== "number") throw "Expected children of gt to be a number"
      return children[0] > children[1]
    
    case "lt":
      if(children.length !== 2) throw "Expected 2 children for lt"
      if(typeof children[0] !== "number" || typeof children[1] !== "number") throw "Expected children of lt to be a number"
      return children[0] < children[1]
    ...
    case "gt_or_eq":
      ...
      if(typeof children[0] !== "number" || typeof children[1] !== "number") throw "Expected children of gt_or_eq to be a number"
      return children[0] >= children[1]

    case "lt_or_eq":
      if(children.length !== 2) throw "Expected 2 children for lt_or_eq"
      if(typeof children[0] !== "number" || typeof children[1] !== "number") throw "Expected children of lt_or_eq to be a number"
      return children[0] <= children[1]
