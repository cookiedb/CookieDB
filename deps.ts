...
export { resolve } from "https://deno.land/std@0.171.0/path/mod.ts";
export { serve, serveTls } from "https://deno.land/std@0.171.0/http/server.ts";
export { ensureDirSync } from "https://deno.land/std@0.171.0/fs/mod.ts";
export {
  assert,
  assertEquals,
  assertNotEquals,
...
export {
  deepmerge,
} from "https://deno.land/x/deepmergets@v4.2.2/dist/deno/index.ts";
